...
module.exports = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(
                "button",
                { className: "cookie-button", onClick: this.props.handleClick },
                "mooar cookies!"
            )
        );
    }
...
var Game = React.createClass({
    ...
    defaultGameValues: function defaultGameValues() {
        return {
            cookie_counter: 0,
            cursor_counter: 0,
            cursor_price: 10,
    ...
    updateValues: function updateValues() {
        this.setState({
            cookie_counter: this.state.cookie_counter + this.state.cursor_cps * this.state.cursor_counter * (this.state.fps / 1000) + this.state.granma_cps * this.state.granma_counter * (this.state.fps / 1000)
        });
    },
...
},{"./cookie-button.js":1,"./items.js":2,"./session-manager.js":4,"react":159}],4:[function(require,module,exports){
"use strict";

module.exports = {

    saveSession: function saveSession(state) {
